...
Citizen.CreateThread(function()
    while true do
        ...
        if onCreatorTick.FaceTurnEnabled then
            ...
            if IsControlJustReleased(2, 205) or
                IsDisabledControlJustReleased(1, 205) then
...
function setupScaleform()
    ...
    ButtonMessage("Tourner votre tête à droite")
    PopScaleformMovieFunctionVoid()

    PushScaleformMovieFunction(scaleform, "SET_DATA_SLOT")
    PushScaleformMovieFunctionParameterInt(0)
    N_0xe83a3e3557a56640(GetControlInstructionalButton(2, 44, true))
    ButtonMessage("Tourner votre tête à gauche")
    PopScaleformMovieFunctionVoid()
...
function KeyboardInput(b, c)
    AddTextEntry('FMMC_KEY_TIP12', "")
    DisplayOnscreenKeyboard(1, "FMMC_KEY_TIP12", "", b, "", "", "", c)
    while UpdateOnscreenKeyboard() ~= 1 and UpdateOnscreenKeyboard() ~= 2 do
        Citizen.Wait(0)
    end
    if UpdateOnscreenKeyboard() ~= 2 then
        result = callback(GetOnscreenKeyboardResult())
        Citizen.Wait(500)
        return result
    else
        Citizen.Wait(500)
...
local j = {"Benjamin", "Daniel", "Joshua", "Noah", "Andrew", "Juan", "Alex", "Isaac", "Evan", "Ethan", "Vincent", "Angel", "Diego", "Adrian", "Gabriel", "Michael", "Santiago", "Kevin", "Louis", "Samuel", "Anthony", "Hannah", "Audrey", "Jasmine", "Giselle", "Amelia", "Isabella", "Zoe", "Ava", "Camilia", "Violet", "Sophie", "Evelyn", "Nicole", "Ashley", "Grace", "Briana", "Natalie", "Olivia", "Elizabeth", "Charlotte", "Emma", "Niko", "John"}

local k = {"Benjamin", "Daniel", "Joshua", "Noah", "Andrew", "Juan", "Alex", "Isaac", "Evan", "Ethan", "Vincent", "Angel", "Diego", "Adrian", "Gabriel", "Michael", "Santiago", "Kevin", "Louis", "Samuel", "Anthony", "Hannah", "Audrey", "Jasmine", "Giselle", "Amelia", "Isabella", "Zoe", "Ava", "Camilia", "Violet", "Sophie", "Evelyn", "Nicole", "Ashley", "Grace", "Briana", "Natalie", "Olivia", "Elizabeth", "Charlotte", "Emma", "Niko", "John"}

local l = { "Vert", "Emeraude", "Bleu clair", "Bleu marine", "Chatain", "Marron fonce", "Noisette", "Gris fonce", "Gris clair" }
    ...
    Events = {
        ...
        onSelected = function(self, m, n, o, p, q, r, s, result, t)
            ...
            elseif n == "Vêtements" then
                ...
                CreatorZoomOut(GetCreatorCam())
                UpdateCreatorTick("FaceTurnEnabled", false)
            elseif n == "~g~Valider & continuer" then
                UpdateCreatorTick("FaceTurnEnabled", false)
                CreatorZoomOut(GetCreatorCam())
            ...
            elseif n == "Valider" then
                if ResultPrenom and ResultNom and datedenaissance and ResultLieuNaissance and taille and ResultSexe == result then
                    TriggerServerEvent('skusku:saveidentite', ResultSexe, ResultPrenom, ResultNom, datedenaissance, taille)
                    ...
                    CloseCreatorMenu()
                    TriggerEvent('skusku:launchCharMovie')
                else
        ...
        onSlide = function(p, n, q, s)
            ...
            if t == 22 and G == "Père" then
                creator.Menu["Héritage"].father = "female_0"
            end
            if t == 23 and G == "Père" then
                creator.Menu["Héritage"].father = "female_1"
            end
            if t == 24 and G == "Père" then
                creator.Menu["Héritage"].father = "female_2"
            end
            if t == 25 and G == "Père" then
                creator.Menu["Héritage"].father = "female_3"
            end
            if t == 26 and G == "Père" then
                creator.Menu["Héritage"].father = "female_4"
            end
            if t == 27 and G == "Père" then
                creator.Menu["Héritage"].father = "female_5"
            end
            if t == 28 and G == "Père" then
                creator.Menu["Héritage"].father = "female_6"
            end
            if t == 29 and G == "Père" then
                creator.Menu["Héritage"].father = "female_7"
            end
            if t == 30 and G == "Père" then
                creator.Menu["Héritage"].father = "female_8"
            end
            if t == 31 and G == "Père" then
                creator.Menu["Héritage"].father = "female_9"
            end
            if t == 32 and G == "Père" then
                creator.Menu["Héritage"].father = "female_10"
            end
            if t == 33 and G == "Père" then
                creator.Menu["Héritage"].father = "female_11"
            end
            if t == 34 and G == "Père" then
                creator.Menu["Héritage"].father = "female_12"
            end
            if t == 35 and G == "Père" then
                creator.Menu["Héritage"].father = "female_13"
            end
            if t == 36 and G == "Père" then
                creator.Menu["Héritage"].father = "female_14"
            end
            if t == 37 and G == "Père" then
                creator.Menu["Héritage"].father = "female_15"
            end
            if t == 38 and G == "Père" then
                creator.Menu["Héritage"].father = "female_16"
            end
            if t == 39 and G == "Père" then
                creator.Menu["Héritage"].father = "female_17"
            end
            if t == 40 and G == "Père" then
                creator.Menu["Héritage"].father = "female_18"
            end
            if t == 41 and G == "Père" then
                creator.Menu["Héritage"].father = "female_19"
            end
            if t == 42 and G == "Père" then
                creator.Menu["Héritage"].father = "female_20"
            end
            ...
            if t == 22 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_0"
            end
            if t == 23 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_1"
            end
            if t == 24 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_2"
            end
            if t == 25 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_3"
            end
            if t == 26 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_4"
            end
            if t == 27 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_5"
            end
            if t == 28 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_6"
            end
            if t == 29 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_7"
            end
            if t == 30 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_8"
            end
            if t == 31 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_9"
            end
            if t == 32 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_10"
            end
            if t == 33 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_11"
            end
            if t == 34 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_12"
            end
            if t == 35 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_13"
            end
            if t == 36 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_14"
            end
            if t == 37 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_15"
            end
            if t == 38 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_16"
            end
            if t == 39 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_17"
            end
            if t == 40 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_18"
            end
            if t == 41 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_19"
            end
            if t == 42 and G == "Mère" then
                creator.Menu["Héritage"].mother = "male_20"
            end
    ...
    Menu = {
        ["Création de personnage"] = {
            b = {
                ...
                {name = "~g~Valider & continuer", askX = true}
            }
        },
        ["Héritage"] = {
            extra = true,
        ...
        ["Personnage"] = {
            useFilter = true,
            b = {
                {name = "mp_m_freemode_01", skin = 0},
                {name = "mp_f_freemode_01", skin = 1},
...
AddEventHandler("skusku:launchCharMovie", function()
    local function _(U)
